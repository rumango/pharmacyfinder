        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <!-- InstanceBeginEditable name="EditRegion4" --><a class="navbar-brand" href="#">Stock Management</a><!-- InstanceEndEditable --></div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Drugs Instock</h4>
  <button type="button" id="btn" class="btn btn-sm btn-danger btn-fill pull-right" data-toggle="modal" data-target="#addDrug">Enrol Drugs</button>
                                
                            </div>
                            <!--Toget the list of drugs to be displayed-->
